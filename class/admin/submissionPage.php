...
class SubmissionPage extends AdminPage{
    public function generateContent() {
        ...
        echo "<td><strong>Team ID</strong></td><td><strong>Team Name</strong></td><td><strong>Latest Case Submission</strong></td></tr>";
        echo "<tbody>";
        for ($i=0; $i<$numRows; $i++){
            ...
            $fileName = urlencode($row['submission_id']."-".$row['file_name']);
